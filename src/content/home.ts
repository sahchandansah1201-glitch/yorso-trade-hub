/**
 * YORSO homepage content layer (i18n-ready). English copy.
 * Numbers are verified current-state facts. Do not inflate.
 * Items marked [future] / [future workflow] are not live yet.
 */
